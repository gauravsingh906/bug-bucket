    ...
    return (
        <div className="container mx-auto space-y-6 px-6 pb-20 pt-32 bg-black">
                ...
                <div className="w-40 shrink-0">
                    <picture className="block w-full">
                        <img
                            ...
                            alt={user.name}
                            className="h-full w-full rounded-full object-cover border-4 border-gradient-to-br from-blue-500 to-purple-500 shadow-lg"
                        />
                    </picture>
                </div>
                <div className="flex-1">
                    <div className="flex items-start justify-between">
                        <div className="block space-y-1">
                            <h1 className="text-3xl md:text-4xl font-bold text-white hover:text-cyan-300 transition-colors duration-200">{user.name}</h1>
                            ...
                            <p className="flex items-center gap-1 text-sm text-gray-400">
                                <IconClockFilled className="w-4 shrink-0" /> Last active{" "}
            ...
            <div className="flex flex-col gap-6 sm:flex-row">
                <Navbar />
                <div className="flex-1 p-4 rounded-lg shadow-inner bg-gray-700">{children}</div> {/* Dark background for children */}
            </div>
        </div>
